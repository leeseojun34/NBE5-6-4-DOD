...
export default function SocialAuthTokensEdit() {
  ...
  return (<>
    <div className="flex flex-wrap mb-6">
      <h1 className="grow text-3xl md:text-4xl font-medium mb-2">{t('socialAuthTokens.edit.headline')}</h1>
      <div>
        <Link to="/socialAuthTokenss" className="inline-block text-white bg-gray-500 hover:bg-gray-600 focus:ring-gray-200 focus:ring-4 rounded px-5 py-2">{t('socialAuthTokens.edit.back')}</Link>
      </div>
    </div>
